...
class App:
    ...
    def __init__(self, root):
        ...
        self.joysticks["y-10"]=GButton_138
        ...
        self.joysticks["x-10"] = GButton_96
        ...
        self.joysticks["x10"] = GButton_492
        ...
        self.joysticks["y10"] = GButton_125
        ...
        GButton_805.place(x=140,y=130,width=30,height=30)
        ...
        GButton_303.place(x=180,y=130,width=30,height=30)
        ...
        GButton_446["text"] = "Volume"
        GButton_446.place(x=220,y=130,width=30,height=30)
        ...
        GButton_244["text"] = "~"
        GButton_244.place(x=260,y=130,width=30,height=30)
        ...
        GButton_934.place(x=300,y=130,width=48,height=30)
        ...
        GButton_830["text"] = "["
        GButton_830.place(x=360,y=130,width=30,height=30)
        GButton_830["command"] = self.GButton_830_command


        self.keys["["] = GButton_830
        ...
        GButton_692["text"] = "]"
        GButton_692.place(x=400,y=130,width=31,height=30)
        GButton_692["command"] = self.GButton_692_command

        self.keys["]"] = GButton_692

        GButton_913=tk.Button(root)
        GButton_913["bg"] = "#efefef"
        ft = tkFont.Font(family='Times',size=10)
        GButton_913["font"] = ft
        GButton_913["fg"] = "#000000"
        GButton_913["justify"] = "center"
        GButton_913["text"] = "F"
        GButton_913.place(x=240,y=250,width=30,height=30)
        GButton_913["command"] = self.GButton_913_command

        self.keys["F"] = GButton_913
        ...
        GButton_729["text"] = "="
        GButton_729.place(x=480,y=130,width=30,height=30)
        GButton_729["command"] = self.GButton_729_command

        self.keys["="] = GButton_729
        ...
        GButton_860["text"] = "X"
        GButton_860.place(x=590,y=60,width=30,height=30)
        ...
        GButton_473.place(x=550,y=60,width=30,height=30)
        ...
        GButton_594["bg"] = "#efefef"
        ft = tkFont.Font(family='Times',size=10)
        GButton_594["font"] = ft
        GButton_594["fg"] = "#000000"
        GButton_594["justify"] = "center"
        GButton_594["text"] = "H"
        GButton_594.place(x=320,y=250,width=30,height=30)
        GButton_594["command"] = self.GButton_594_command

        self.assignKey(GButton_594)
        ...
        GButton_632["text"] = "Enter"
        GButton_632.place(x=560,y=250,width=58,height=30)
        GButton_632["command"] = self.GButton_632_command

        self.assignKey(GButton_632)
        ...
        GButton_818.place(x=50,y=210,width=54,height=30)
        ...
        GButton_28["text"] = "\\"
        GButton_28.place(x=510,y=210,width=30,height=30)
        ...
        GButton_997.place(x=550,y=210,width=68,height=30)
        ...
        GButton_690["text"] = "Tab/Caps"
        GButton_690.place(x=50,y=250,width=61,height=30)
        ...
        GButton_229["text"] = "'"
        GButton_229.place(x=520,y=250,width=30,height=30)
        ...
        GButton_59.place(x=50,y=290,width=66,height=30)
        GButton_59["command"] = self.GButton_59_command

        self.keys["Shift"] = GButton_59
        ...
        GButton_401.place(x=570,y=290,width=49,height=30)
        ...
        GButton_994["text"] = "Fn"
        GButton_994.place(x=60,y=330,width=51,height=30)
        GButton_994["command"] = self.GButton_994_command

        #self.assignKey(GButton_994)
        ...
        GButton_430["text"] = "Ctrl"
        GButton_430.place(x=120,y=330,width=40,height=30)
        GButton_430["command"] = self.GButton_430_command

        self.keys["Ctrl"] = GButton_430

        GButton_548=tk.Button(root)
        GButton_548["bg"] = "#efefef"
        ft = tkFont.Font(family='Times',size=10)
        GButton_548["font"] = ft
        GButton_548["fg"] = "#000000"
        GButton_548["justify"] = "center"
        GButton_548["text"] = "Cmd"
        GButton_548.place(x=170,y=330,width=30,height=30)
        GButton_548["command"] = self.GButton_548_command

        self.keys["Cmd_r"] = GButton_548
        ...
        GButton_420.place(x=210,y=330,width=30,height=30)
        GButton_420["command"] = self.GButton_420_command

        self.keys["Alt"] = GButton_420
        ...
        GButton_454.place(x=250,y=330,width=151,height=30)
        ...
        GButton_203["bg"] = "#efefef"
        ft = tkFont.Font(family='Times',size=10)
        GButton_203["font"] = ft
        GButton_203["fg"] = "#000000"
        GButton_203["justify"] = "center"
        GButton_203["text"] = "←"
        GButton_203.place(x=490,y=330,width=30,height=30)
        GButton_203["command"] = self.GButton_203_command

        self.keys["Left"] = GButton_203
        ...
        GButton_164["text"] = "→"
        GButton_164.place(x=570,y=330,width=30,height=30)
        GButton_164["command"] = self.GButton_164_command

        self.keys["Right"] = GButton_164
        
        GButton_388=tk.Button(root)
        GButton_388["bg"] = "#efefef"
        ft = tkFont.Font(family='Times',size=10)
        GButton_388["font"] = ft
        GButton_388["fg"] = "#000000"
        GButton_388["justify"] = "center"
        GButton_388["text"] = "↓"
        GButton_388.place(x=530,y=330,width=30,height=30)
        GButton_388["command"] = self.GButton_388_command

        self.keys["Down"] = GButton_388
        ...
        GButton_415["text"] = "中键"
        GButton_415.place(x=290,y=370,width=60,height=30)
        ...
        GButton_267["text"] = "右键"
        GButton_267.place(x=360,y=370,width=49,height=30)
        GButton_267["command"] = self.GButton_267_command

        self.mouse["right"] = GButton_267
        ...
        GButton_921["text"] = "-"
        GButton_921.place(x=440,y=130,width=30,height=30)
        ...
        GButton_696["text"] = "A"
        GButton_696.place(x=600,y=100,width=30,height=30)
        ...
        GLabel_975["text"] = "提示符"
        GLabel_975.place(x=150,y=30,width=398,height=35)
        ...
        GButton_550.place(x=20,y=130,width=64,height=45)
